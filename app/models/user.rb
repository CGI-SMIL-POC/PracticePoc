class User < ActiveRecord::Base
  ...
  validates :password, presence: { :message => "The  Password is required"}, length: { maximum: 20}
  validates :password_confirmation, presence: { :message => "The Confirm Password is required"}, length: { maximum: 20}
